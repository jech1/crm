...
export function ProfileHeader({ restaurant, canEdit }: ProfileHeaderProps) {
  return (
    <div className="rounded-xl border bg-white p-4 sm:p-6">
        ...
        */}
        <div className="flex flex-col gap-3 sm:shrink-0 sm:items-end">
          ...
          <div className="sm:text-right">
            ...
            <div className="w-24 h-1.5 bg-slate-100 rounded-full mt-1 sm:ml-auto">
              <div
      ...
      */}
      <div className="grid grid-cols-2 gap-3 mt-5 pt-5 border-t sm:grid-cols-4 sm:gap-4">
        <div className="text-center">
          <p className="text-lg font-semibold text-slate-900">{restaurant._count.visits}</p>
          <p className="text-xs text-slate-500">Visits</p>
        </div>
        <div className="text-center">
          <p className="text-lg font-semibold text-slate-900">{restaurant._count.meetings}</p>
          <p className="text-xs text-slate-500">Meetings</p>
        </div>
        <div className="text-center">
          <p className="text-lg font-semibold text-slate-900">{restaurant._count.tasks}</p>
          <p className="text-xs text-slate-500">Open Tasks</p>
        </div>
        <div className="text-center">
          <p className="text-lg font-semibold text-slate-900">{restaurant._count.warmIntros}</p>
          <p className="text-xs text-slate-500">Warm Intros</p>
        </div>
      </div>
    </div>
  )
